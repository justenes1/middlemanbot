...
async function registerCommands() {
    ...
    const rest = new REST().setToken('MTQ0NzM2NjA1NjkwNDQ5MTA3OQ.GwqJhI.kjmq9_s6TPNaFgJqmlawW-68zaBPPDA74qXzJM');
    try {
...
client.once('ready', async () => {
    ...
    const payementChecker = require('./services/payementChecker');
...
// Start the Bot
// ========================
client.login('MTQ0NzM2NjA1NjkwNDQ5MTA3OQ.GwqJhI.kjmq9_s6TPNaFgJqmlawW-68zaBPPDA74qXzJM');